...
[![Build Status](https://travis-ci.com/beijbom/pyspacer.svg?branch=master)](https://travis-ci.org/beijbom/pyspacer)
...
```
docker run -v /path/to/your/local/models:/workspace/models -v ${PWD}:/workspace/spacer/ -it spacer:test bash
```
